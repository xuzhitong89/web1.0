...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNames: ['1\u6708', '2\u6708', '3\u6708', '4\u6708', '5\u6708', '6\u6708', '7\u6708', '8\u6708', '9\u6708', '10\u6708', '11\u6708', '12\u6708'], // For formatting
...
$.extend(Datepicker.prototype, {
    ...
    _clickTitle: function(id, year, month) {
        var target = $(id);
        var inst = this._getInst(target[0]);
        var onClickTitle = this._get(inst, 'onClickTitle');
        if(onClickTitle)
            onClickTitle.apply(null, [year, "0" + (month+1)]);
    },
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		var html = '<div class="ui-datepicker-title" onclick="DP_jQuery_' + dpuuid + '.datepicker._clickTitle(\'#' + inst.id + '\', ' + drawYear + ',' + drawMonth + ');">';
		var monthHtml = '';
		// month selection
