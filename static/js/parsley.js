  ...
  */
  $.fn.parsley.defaults = {
    ...
    , errors: {
      ...
      , errorsWrapper: '<span></span>'                                        // do not set an id for this elem, it would have an auto-generated id
      , errorElem: '<span></>'                                            // each field constraint fail in an li
      }
    , listeners: {
        onFieldValidate: function ( elem, ParsleyForm ) { return false; } // Executed on validation. Return true to ignore field validation
      , onFormSubmit: function ( isFormValid, event, ParsleyForm ) {}     // Executed once on form validation
      , onFieldError: function ( elem, constraints, ParsleyField ) {$(elem).nextAll("span.help-inline").hide()}     // Executed when a field is detected as invalid
      , onFieldSuccess: function ( elem, constraints, ParsleyField ) {$(elem).parents("div.control-group").removeClass("error");$(elem).nextAll("span.help-inline").hide()}   // Executed when a field passes validation
    }
  };
